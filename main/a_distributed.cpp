...
void a_distributed() {
    ...
    CheckerboardTexture* ck = new CheckerboardTexture(RGBColor(1.0f, 0.9f, 0.7f), RGBColor(0.2f, 0.2f, 0.0f));
    //m->add(new GlassMaterial(1.45f), t1, 1.f);
    m->add(new GlassMaterial(1.45f), ck, 0.5);
    ...
    renderCornellbox(0.001f, "a6-6.png", cam, m, floorMaterial2, 10);
