...
MatLib* getCandleGlass2() {
    ...
    glass->insert(std::pair<std::string, Material*>("Glass", new GlassMaterial(1.45f)));
    return glass;
}
...
MatLib* getCandleGlass3() {
    ...
    ConstantTexture* t2 = new ConstantTexture(RGBColor(114.f, 242.f, 233.f) / 255.f);
...
MatLib* getPlantJar() {
    ...
    Texture* t1 = new ImageTexture("models/candle2.png");
    ConstantTexture* t2 = new ConstantTexture(RGBColor(239.f, 141.f, 50.f) / 255.f);
    CombineMaterialTex* m = new CombineMaterialTex();
...
void RC() {
 ...
 //   Texture* bpumpkin = new ImageTexture("models/pbmap.png");
   ...
   MatLib* leaf = getLeaf();
    ...
    img.writePNG("scene_full_res.png");
}
